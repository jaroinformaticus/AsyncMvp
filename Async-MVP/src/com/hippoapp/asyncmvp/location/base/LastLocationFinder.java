...
public abstract class LastLocationFinder {
	...
	protected LastLocationFinder(Context context) {
	 ...
	 */
	public abstract Location getLastBestLocation(int minDistance, long minTime);
	 ...
	 *            LocationListener
	 */
	public abstract void setChangedLocationListener(LocationListener l);
	...
	protected Location getBestLocationResult(float bestAccuracy, long bestTime,
			long minTime) {
