...
final class CustomConcurrentHashMap {
    ...
    static final class Builder {
        ...
        /**
		 * @uml.property  name="initialCapacity"
		 */
        int initialCapacity = UNSET_INITIAL_CAPACITY;
        /**
		 * @uml.property  name="concurrencyLevel"
		 */
    ...
    static class Impl<K, V, E> extends AbstractMap<K, V> implements ConcurrentMap<K, V>,
        ...
        abstract class HashIterator {
            ...
            E nextEntry;
            /**
			 * @uml.property  name="nextExternal"
			 * @uml.associationEnd  
			 */
            WriteThroughEntry nextExternal;
            /**
			 * @uml.property  name="lastReturned"
			 * @uml.associationEnd  
			 */
    ...
    static class ComputingImpl<K, V, E> extends Impl<K, V, E> {
        ...
        /**
		 * @uml.property  name="computingStrategy"
		 * @uml.associationEnd  
		 */
