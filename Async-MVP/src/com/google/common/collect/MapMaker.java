...
public final class MapMaker {
    ...
    private static class StrategyImpl<K, V> implements Serializable,
        ...
        /**
		 * Points to an old entry where a value is being computed. Used to support non-blocking copying of entries during table expansion, removals, etc.
		 */
    ...
    private interface ReferenceEntry<K, V> {
		 ...
		 * @uml.property  name="valueReference"
		 * @uml.associationEnd  
		 */
